...
if __name__ == '__main__':
    ...
    filenames = [os.path.join(train_data_dir, f) for f in filenames if f.endswith('.npy')]

    test_filenames = os.listdir(test_data_dir)
    test_filenames = [os.path.join(test_data_dir, f) for f in test_filenames if f.endswith('.npy')]
